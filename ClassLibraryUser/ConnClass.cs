...
namespace ClassLibraryUser
{
    public class ConnClass
    {
        ...
        //Propriedades
        private const string Server = "TAU0712128W11-1\\SQLEXPRESS"; //propriedades do SQL SERVER// nome do servidor
        ...
        public string strConn = $"Data Source= {Server}; Initial Catalog = {DataBase}; User Id= {User}; Password = {Password}; Encrypt =false";
